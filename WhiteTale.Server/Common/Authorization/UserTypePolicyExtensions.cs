...
internal static class UserTypePolicyExtensions
{
	...
	internal static TBuilder RequireUserType<TBuilder>(this TBuilder builder, params IReadOnlyList<UserType> authorized)
		where TBuilder : IEndpointConventionBuilder
	{
		_ = builder
			.RequireAuthorization(PolicyName)
			.WithMetadata(new RequireUserTypeAttribute(authorized));
		return builder;
	}
