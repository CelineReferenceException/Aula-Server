...
internal static class ProblemDetailsDefaults
{
	...
	internal static ProblemDetails InvalidBanCount { get; } = new()
	{
		...
		Detail = $"The ban count must be between {GetBansApiEndpoint.MinimumBanCount} and {GetBansApiEndpoint.MaximumBanCount}.",
		Status = StatusCodes.Status400BadRequest,
	};

	internal static ProblemDetails InvalidAfterUser { get; } = new()
	{
		Title = $"Invalid '{GetBansApiEndpoint.AfterQueryParameter}' query parameter.",
